...
class AssessEnvironment(Action):
    ...
    - There are obstacles ahead in the environment.
...
class AssessLiquidStatus(Action):
    ...
    Additional Information:
    - The liquid being transported is honey, which is a viscous substance.
...
class EnvironmentRobot(Role):
    ...
    def __init__(self, **data: Any):
        super().__init__(**data)
        self.set_actions([AssessEnvironment(), FinalDecision()])
        self._set_react_mode(react_mode=RoleReactMode.BY_ORDER.value)
        self._watch([UserRequirement, AssessEnvironment, FinalDecision])
...
class LiquidRobot(Role):
    ...
    def __init__(self, **data: Any):
        super().__init__(**data)
        self.set_actions([AssessLiquidStatus(), FinalDecision()])
        self._set_react_mode(react_mode=RoleReactMode.BY_ORDER.value)
        self._watch([UserRequirement, AssessLiquidStatus, FinalDecision])
        self.assessment_result = ""
        self.topic = "liquid transport mission"  # 初始化topic
...
if __name__ == "__main__":
    fire.Fire(main)
# rosrun obstacle_honey_room two_round.py --idea "liquid transport mission"