...
class AssessDebris(Action):
    ...
    - The current search environment consists entirely of small ruins with no large collapsed structures.
    ...
    def subscribe_to_camera(self):
        rospy.Subscriber("/rgb_simple_ruin_robot", Image, self.image_callback)
...
class AssessSurvivor(Action):
    ...
    def subscribe_to_camera(self):
        rospy.Subscriber("/rgb_simple_ruin_dog", Image, self.image_callback)
...
# rosrun small_debris_many_persons four_round.py --idea "joint rescue mission"
